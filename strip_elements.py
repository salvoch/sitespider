...
class PandocStripper:
    ...
    def __init__(self, file_path: Path) -> None:
        ...
        with file_path.open() as file:
            read_file = file.read()
            self.pandoc_file = pandoc.read(read_file, format="markdown")
    ...
    def strip_local_image_locations(self) -> list[ImageReference]:
...
if __name__ == '__main__':
    pan_obj = PandocStripper(Path('test.md'))
    print(pan_obj.strip_title())
    print(pan_obj.strip_local_image_locations())
